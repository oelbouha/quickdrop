...
class AppColors {
  ...
  static const Color tabBarBorderColor = Color(0xFFE0E0E0);
  ...
  // TabBar
  static const Color tabTextActive = blue;
  static const Color tabTextInactive = lightGray;
  static const Color tabIndicator = Color.fromARGB(255, 1, 101, 141);
  ...
  static const Color cardBorder = Color(0x33FFFFFF);         // border-white/20
  
  // Text Colors
  static const Color textPrimary = Color(0xFF111827);   // text-gray-900
  ...
  static const Color textLight = Color(0xFF9CA3AF);     // text-gray-400
  ...
  static const Color borderBlue300 = Color(0xFF93C5FD);
