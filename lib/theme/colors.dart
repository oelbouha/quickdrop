...
class AppColors {
  static const Color background = Color(0xFF111827); // Main background
  static const Color blue = Color(0xFF4d6bfe); // Active color
  static const Color headingText = Color(0xFFffffff); // Heading text
  ...
  static const Color barColor = Color(0xFF1F2937);
