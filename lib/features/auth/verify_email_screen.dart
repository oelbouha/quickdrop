        ...
        body: Padding(
            ...
            child: Center(
              ...
              children: [
                ...
                LoginButton(
                  hintText: "I've verified my email",
                  onPressed: () async {
                    ...
                    if (user != null && user.emailVerified) {
                      ...
                      AppUtils.showDialog(context,
                          "Please verify your email first.", AppColors.error);
                    }
                  },
                  isLoading: false,
                  radius: 12,
                ...
                LoginButton(
                  hintText: "Resend verification link",
                  onPressed: () async {
                    await FirebaseAuth.instance.currentUser?.reload();
                    User? user = FirebaseAuth.instance.currentUser;
                    await user?.sendEmailVerification();
                    AppUtils.showDialog(context, "A new email has been sent.",
                        AppColors.succes);
                  },
                  isLoading: false,
                  radius: 12,
